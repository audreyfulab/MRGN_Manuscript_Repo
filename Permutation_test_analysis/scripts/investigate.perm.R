...
save(perm.all, file = "Permutation_test_analysis/results/perm.all.trios.WB.RData")
#no permutation
no.perm = sapply(data.with.pcs, infer.trio, gamma = 0.5, use.perm = F, nperms = 1000)
save(no.perm, file = "Permutation_test_analysis/results/no.perm.all.trios.WB.RData")
