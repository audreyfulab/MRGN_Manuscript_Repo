...
confs=get.conf.trios(trios=just.trios, cov.pool=conf.mat, blocksize = 100, selection_fdr = 0.05,
                     filter_fdr = 0.1, filter_int_child = T, adjust_by = 'none', alpha = 0.01)

save(confs, file = "Simulation/data/many_conf_data/alpha_01_selected_confs_results/MRGN_many_confs_liberal_alpha01_conf_output.RData")
...
save(conf.list, file = "Simulation/data/many_conf_data/alpha_01_selected_confs_results/MRGN_many_conf_liberal_sel_alpha01_conf_list.RData")
...
save(trios.with.pcs2, file = "Simulation/data/many_conf_data/alpha_01_selected_confs_results/MRGN_many_conf_liberal_alpha01_DATA_W_SELECTED_CONFS.RData")
...
#save
save(reg.res, file = "Simulation/data/many_conf_data/alpha_01_selected_confs_results/mrgn_many_conf_liberal_alpha01_reg_results.RData")
save(inf.mods, file = "Simulation/data/many_conf_data/alpha_01_selected_confs_results/mrgn_many_conf_liberal_alpha01_inf_results.RData")
save(params, file = "Simulation/data/diagnostics/alpha_01_selected_confs_results/mrgn_many_conf_liberal_alpha01_params_with_comp_times.RData")
