...
gmac.cis=loadRData(file="Simulation/data/many_conf_data/gmac_300_cis_results_all_confs_all_mods.RData")
gmac.trans=loadRData(file="Simulation/data/many_conf_data/gmac_300_trans_results_all_confs_all_mods.RData")
mrgn.inf=loadRData(file="Simulation/data/many_conf_data/mrgn_300_inf_results_all_confs_all_mods.RData")
mrgn.reg.res=loadRData(file="Simulation/data/many_conf_data/mrgn_300_regres_results_all_confs_all_mods.RData")
mrgn.reg.res.alpha01 = loadRData(file = "Simulation/data/many_conf_data/alpha_01_selected_confs_results/mrgn_many_conf_liberal_alpha01_reg_results.RData")
mrgn.resmat.alpha01 = do.call('rbind', mrgn.reg.res.alpha01)
mrgn.confs = loadRData(file = "Simulation/data/many_conf_data/mrgn_300_conf_list_all_confs_all_mods_REG.RData")
mrgn.inf.alpha01 = loadRData(file = "Simulation/data/many_conf_data/alpha_01_selected_confs_results/mrgn_many_conf_liberal_alpha01_inf_results.RData")
mrgn.confs.alpha01 = loadRData(file = "Simulation/data/many_conf_data/alpha_01_selected_confs_results/MRGN_many_conf_liberal_sel_alpha01_conf_list.RData")


#mrpc.inf=loadRData(file="Simulation/data/many_conf_data/mrpc_300_small_results_all_confs_all_mods.RData")
all.mods=loadRData(file="Simulation/data/many_conf_data/mrgn_v_gmac_v_mrpc_300_datasets_all_mods_conf_types.RData")
sel.confs = loadRData(file="Simulation/data/many_conf_data/mrgn_data_300_with_SELECTED_CONFS_REG.RData")
...
save(master.table, file="Simulation/data/many_conf_data/master_table_MANY_CONF_all_confs_all_mods.RData")
save(gmac.trans, file="Simulation/data/many_conf_data/gmac_300_trans_results_all_all_mods_conf_types_preproc.RData")
save(gmac.cis, file="Simulation/data/many_conf_data/gmac_300_cis_results_all_mods_all_conf_types_proproc.RData")
#confusion matrices
table(MRGN = convert.cats(master.table$mrgn.infer), TRUTH = master.table$model)
table(MRPC = convert.cats(master.table$mrpc.infer), TRUTH = master.table$model)
table(GMAC = master.table$gmac.infer, TRUTH = master.table$model)
...
#                        trios.idx = input.list$trio.indexes[1:10,], nperm = input.list$nperm,
#                        nominal.p = TRUE)
