...
save(out.list.trans, file = "Simulation/data/many_conf_data/gmac_300_trans_results_all_confs_all_mods.RData")
save(out.list.cis, file = "Simulation/data/many_conf_data/gmac_300_cis_results_all_confs_all_mods.RData")
