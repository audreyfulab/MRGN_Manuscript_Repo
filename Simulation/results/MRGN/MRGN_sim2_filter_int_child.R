...
save(confs, file = "Simulation/data/int_and_child_filtered_data/confs_mrgn_mrpc_get_conf_out_all.RData")
...
save(conf.list, file = "Simulation/data/int_and_child_filtered_data/mrgn_5k_conf_list_all_confs_filtered_all_mods.RData")
...
save(trios.with.pcs2, file = "Simulation/data/int_and_child_filtered_data/mrgn_data_with_SELECTED_CONFS_filtered.RData")
...
#save
save(params, file = "Simulation/data/diagnostics/mrgn_comp_times_with_filtering.RData")
save(reg.res, file = "Simulation/data/int_and_child_filtered_data/mrgn_5k_regres_results_all_confs_filtered_all_mods.RData")
save(inf.mods, file = "Simulation/data/int_and_child_filtered_data/mrgn_5k_inf_results_all_confs_filtered_all_mods.RData")
