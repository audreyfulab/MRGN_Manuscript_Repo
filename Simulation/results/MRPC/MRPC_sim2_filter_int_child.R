...
save(conf.list, file = "Simulation/data/int_and_child_filtered_data/mrpc_5k_conf_list_all_confs_filtered_all_mods.RData")
...
#save
save(params, file = "Simulation/data/diagnostics/mrpc_comp_times_with_filtering.RData")
save(mrpc.infer.list, file = "Simulation/data/int_and_child_filtered_data/mrpc_5k_small_results_all_confs_filtered_all_mods.RData")
