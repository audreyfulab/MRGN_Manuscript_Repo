...
for(j in 1:number.of.datasets){
  ...
  d = round(runif(1, min = 14.5, max = 50.5))
...
save(sim.datasets, file = "./data/mrgn_v_gmac_v_mrpc_150_datasets_all_mods_conf_types.RData")
save(conf.mat, file = "./data/many_conf_data/mrgn_v_gmac_v_mrpc_150_datasets_all_mods_conf_types_conf_mat.RData")
save(params, file = "./data/many_conf_data/mrpc_v_mrgn_v_gmac_150_params_all_mods_conf_types.RData")
